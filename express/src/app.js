...
app.post( "/api/peliculas", (req, res) => {
  ...
  //Generar un nuevo ID
            //                                        infoPeliculas[accion][2].id 
  const nuevoId = infoPeliculas[genero].length > 0 ? infoPeliculas[genero][infoPeliculas[genero].length - 1].id + 1 : 1
  ...
  console.log("Película guardada: ", peliculaFinal)
